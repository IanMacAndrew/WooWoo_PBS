      ...
      >
        <div className="max-w-[20rem] sm:max-w-2xl lg:max-w-3xl xl:max-w-5xl pr-4">
          <h1 className="text-[1.75rem] sm:text-[3rem] lg:text-[4rem] xl:text-[5.25rem] font-black leading-[1.05] tracking-tight text-white">
            <span className="block font-extrabold text-[1.35rem] sm:text-[2.5rem] lg:text-[3.25rem] xl:text-[4rem]">Strategy Led AI,</span>
            <span className="block font-extrabold text-[1.35rem] sm:text-[2.5rem] lg:text-[3.25rem] xl:text-[4rem]">Engineered for Your Role,</span>
