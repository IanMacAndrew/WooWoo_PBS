...
const profiles = {
  ...
  accounting: {
    ...
    icon: Calculator,
    name: 'Colin Warner',
    role: 'The numbers are hiding \u2014 not for long',
    tagline: 'Colin\u2019s full profile is on its way \u2014 in the meantime, know that every missing ringgit has a place to be found.',
    bullets: [],
